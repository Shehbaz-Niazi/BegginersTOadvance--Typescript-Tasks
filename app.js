...
let personName = "Dawid Warner";
console.log(personName.toUpperCase());
console.log(personName.toLowerCase());
let sentence = "twinkle twinkle little stars";
...
let famous_person = "Shehbaz Niazi";
let message = "Two And Two Makes Four";
...
let myFriend = ["John William", "Julia Carney", "Tabraish Shamsi", "Joes Buttler"];
...
let vechicles = ["Tesla Model S Plaid", "Ford Mustang Mach-E", "Toyota GR Supra", "Chevrolet Corvette Stingray"];
...
let guestList = ["Emma Watson", "Chris Hemsworth", "Jennifer Lawrence", "Dwayne Johnson"];
...
let removeGuest = guestList.splice(2, 1)[0];
...
let places = ["Hunza Valley", "Amalfi Coast", "Banff National Park"];
console.log("\t  \n Orignal Order  \n");
console.log(places);
console.log("\t  \n Alphbetical Order \n");
...
let cities = ["Karachi", "Abbotobad", "Hazara", "Peshawar"];
...
let fruits = ["Sir zia", "Osama", "Abdullah", "Israr Khan"];
...
let customArray = ["Honda Civic", "honda Civic", "Honda Civic", "Honda civic", "Honda Civic", "Honda Civc"];
...
if (person < 2)
    ...
    console.log("pperson is an adult.");
}
else if (person > 65) {
...
let names = ["Saad ali", "Ibarar Khan", "Shehbaz Niazi", "Admin"];
...
let names1 = ["Stephin", "Joseph", "Martin Madroso"];
if (names1.length > 0) {
...
function isUsernameTaken(username, existingUsernames) {
    return existingUsernames.some(name => name.toLowerCase() === username.toLowerCase());
}
const current_users = ["iBRAHIM", "joe", "hales", "zia khan", "IBAD"];
const new_users = ["sarah", "ibad", "IBRAHIM", "henry", "mark"];
